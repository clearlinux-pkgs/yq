...
Source0  : https://files.pythonhosted.org/packages/e1/4b/26a31d6016596d27a06f158ae04b7b27d3c51cd15e444a0d5dbac03c0298/yq-3.3.0.tar.gz
...
%prep
%setup -q -n yq-3.3.0
cd %{_builddir}/yq-3.3.0
pushd ..
cp -a yq-3.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713138346
