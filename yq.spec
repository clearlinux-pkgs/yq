...
Source0  : https://files.pythonhosted.org/packages/6e/94/e8401c429419a1d5fa8e2996fdcfa564367a29b88f97d8bfef9138ff5f39/yq-3.1.1.tar.gz
...
%prep
%setup -q -n yq-3.1.1
cd %{_builddir}/yq-3.1.1
pushd ..
cp -a yq-3.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677086473
